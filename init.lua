...
do
    ...
    -- vim.keymap.set('n', '<leader>pv', '<cmd>Neotree toggle<cr>', { desc = 'Project [V]iew (Neo-tree)' })
    -- [[ Basic Autocommands ]]
...
do
    ...
    local parsers = { 'zig', 'rust', 'python', 'toml', 'xml', 'c', 'cpp', 'json', 'yaml', 'bash', 'c', 'diff', 'html',
...
-- ============================================================
do
    -- 1. Install Harpoon2 and its required dependency using native vim.pack
...
do
    ...
    -- Install themes cleanly without mixing types
    vim.pack.add({
        ...
        github('marko-cerovac/material.nvim'),
        github('luisiacc/gruvbox-baby'),
    })

    -- Configure Gruvbox parameters
    vim.g.gruvbox_contrast_dark = 'hard'
    vim.g.gruvbox_italic = 1
    vim.g.gruvbox_bold = 1

    -- Set Gruvbox as Startup Colorscheme
    vim.cmd.colorscheme('gruvbox')

    -- Interactive Telescope Theme Picker Keymap
    vim.keymap.set('n', '<leader>th', '<cmd>Telescope colorscheme enable_preview=true<cr>', {
        desc = '[T]heme [H]ighlight Picker (Live Preview)',
    })
end
